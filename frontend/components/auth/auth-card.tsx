export function AuthCard({ children }: { children: React.ReactNode }) {
  return (
    <main className="grid min-h-screen bg-slate-50 px-4 py-8 lg:grid-cols-[0.95fr_1.05fr] lg:px-8">
      <section className="hidden rounded-lg bg-slate-950 p-8 text-white shadow-2xl lg:flex lg:flex-col lg:justify-between">
        <div>
          <div className="flex items-center gap-3">
            <div className="flex h-11 w-11 items-center justify-center rounded-lg bg-teal-500 text-sm font-bold text-white">
              SG
            </div>
            <div>
